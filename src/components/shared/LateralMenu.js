...
import {Sidebar, Menu, MenuItem, sidebarClasses, ProSidebarProvider} from 'react-pro-sidebar';
                            ...
                            button: ({level, active, disabled}) => {
                                ...
                                if (level === 0)
                                    return {
                                        ...
                                        backgroundColor: active ? '#004a4a' : undefined,
                                    };
                            },
                        }}
                    >
                        <MenuItem style={{textAlign: "center", marginTop: "10px", marginBottom: "10px"}}>
                            <img height="50px"
